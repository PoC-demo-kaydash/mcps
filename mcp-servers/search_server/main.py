...
# 로거 설정
setup_logging()
logger = get_logger("search_server")
...
class SearchServer:
    ...
    async def initialize(self):
        """리소스 초기화"""
        logger.info("=" * 60)
        logger.info("Search Server Initializing...")
        logger.info("=" * 60)
        ...
        # Tool 초기화
        self.tools = {
            "search_documents": SearchDocumentsTool(self.db, self.es),
            "suggest_documents": SuggestDocumentsTool(self.db, self.es)
        }
